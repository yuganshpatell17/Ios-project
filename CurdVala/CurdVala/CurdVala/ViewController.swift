...
class ViewController: UIViewController {
   ...
   @IBAction func cleanRecord(_ sender: Any) {
       ...
       let action1 = UIAlertAction(title: "Delete", style: .destructive) { _ in
           HelperClass.shared.deleteData()
           self.show(message: "All Client has been Deleted!", font: .systemFont(ofSize: 20), timeInterval: 3)
       }
   ...
   @IBAction func shareUS(_ sender: Any) {
    ...
    {
        let vc = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "LiterCounterVCc")
    ...
    {
        let vc = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "ABOuTT")
...
extension UIViewController {
   func show(message : String, font: UIFont,timeInterval:TimeInterval) {
