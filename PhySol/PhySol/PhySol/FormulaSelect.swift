...
@available(iOS 13.0, *)
class FormulaSelect: UIViewController {
    ...
    @IBAction func btn_formula(_ sender: Any) {
        let vc = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(identifier: "FormulaTable") as! FormulaTable
        vc.formulaname = "Formula"
        self.navigationController?.pushViewController(vc, animated: true)
    }
    @IBAction func btn_aboutus(_ sender: Any) {
        let vc = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(identifier: "FormulaAboutUs") as! FormulaAboutUs
        self.navigationController?.pushViewController(vc, animated: true)
    }
